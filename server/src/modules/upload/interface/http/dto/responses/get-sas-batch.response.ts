...
export class SasEntryResponse {
	...
	@ApiPropertyOptional({
		description: "MIME content type used/suggested for the blob",
...
export class GetSasBatchResponse {
	@ApiProperty({
		description: "List of SAS token entries for the requested blobs",
		type: () => [SasEntryResponse],
	})
	@Type(() => SasEntryResponse)
	readonly sas!: SasEntryResponse[];
}
