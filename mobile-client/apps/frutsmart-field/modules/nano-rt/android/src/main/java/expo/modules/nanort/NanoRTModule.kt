...
class NanoRTModule : Module() {
  ...
  override fun definition() = ModuleDefinition {
    ...
    Function("isReady") { readyDeferred.isCompleted }
    ...
    OnCreate { 
      // Solo bootstrap básico en OnCreate, inicialización completa manual
      try {
  ...
  private fun cleanupModule() {
    try {
      Log.i(TAG, "onDestroy_begin")
      ModelManager.shutdownBlocking()
  ...
  private fun saveBitmap(
    ...
    val file = File(getCacheDir(), "nanort_${UUID.randomUUID()}.$extension")
