  ...
  const handleCapture = useCallback(async () => {
    ...
    if (photoResult?.uri) {
      try {
        ...
        console.warn("Persist photo failed, fallback to temp uri:", e);
...
const useNavigation = () => {
  ...
  const navigateToDetection = useCallback(
    (picture: Picture) => {
      ...
      router.replace({
        pathname: "/plant-work/work-flow/internal/detection",
...
// --- Main Component ---
/**
 * Manages the photo capture flow for internal classification. It launches the camera automatically
