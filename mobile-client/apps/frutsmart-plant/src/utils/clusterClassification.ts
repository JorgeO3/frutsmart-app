...
export const ExternalClassificationListData: ClassificationCriteria[] = [
  {
    id: "C1",
    title: "Clase 1",
    imgSrc: require("@/assets/images/app/onboard/cluster-classification/clase1.webp"),
    evaluationPoints: [
  ...
  },
  {
    id: "C2",
    title: "Clase 2",
    imgSrc: require("@/assets/images/app/onboard/cluster-classification/clase2.webp"),
    evaluationPoints: [
  ...
  },
  {
    id: "C3",
    title: "Clase 3",
    imgSrc: require("@/assets/images/app/onboard/cluster-classification/clase3.webp"),
    evaluationPoints: [
  ...
  },
  {
    id: "C4",
    title: "Clase 4",
    imgSrc: require("@/assets/images/app/onboard/cluster-classification/clase4.webp"),
    evaluationPoints: [
...
export const InternalClassificationListData: ClassificationCriteria[] = [
  {
    id: "TA",
    title: "Tipo A",
    imgSrc: require("@/assets/images/app/onboard/cluster-classification/tipoa.webp"),
    evaluationPoints: [
  ...
  },
  {
    id: "TB",
    title: "Tipo B",
    imgSrc: require("@/assets/images/app/onboard/cluster-classification/tipob.webp"),
    evaluationPoints: [
  ...
  },
  {
    id: "TC",
    title: "Tipo C",
    imgSrc: require("@/assets/images/app/onboard/cluster-classification/tipoc.webp"),
    evaluationPoints: [
  ...
  },
  {
    id: "TD",
    title: "Tipo D",
    imgSrc: require("@/assets/images/app/onboard/cluster-classification/tipod.webp"),
    evaluationPoints: [
