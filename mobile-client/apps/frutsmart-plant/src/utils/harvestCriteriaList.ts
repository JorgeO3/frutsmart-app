...
export const HarvestCriteriaListData: HarvestCriteria[] = [
  {
    ...
    imgSrc: require("@/assets/images/app/onboard/harvest-criteria/mature_cluster.webp"),
    evaluationPoints: [
  ...
  },
  {
    ...
    imgSrc: require("@/assets/images/app/onboard/harvest-criteria/non_mature_cluster.webp"),
    evaluationPoints: [
  ...
  },
  {
    ...
    imgSrc: require("@/assets/images/app/onboard/harvest-criteria/over_mature_cluster.webp"),
    evaluationPoints: [
  ...
  },
  {
    ...
    imgSrc: require("@/assets/images/app/onboard/harvest-criteria/long_peduncle_cluster.webp"),
    evaluationPoints: [
  ...
  },
  {
    ...
    imgSrc: require("@/assets/images/app/onboard/harvest-criteria/mal_formed_cluster.webp"),
    evaluationPoints: [
  ...
  },
  {
    ...
    imgSrc: require("@/assets/images/app/onboard/harvest-criteria/rotting_cluster.webp"),
    evaluationPoints: [
  ...
  },
  {
    ...
    imgSrc: require("@/assets/images/app/onboard/harvest-criteria/empty_cluster.webp"),
    evaluationPoints: [
