...
import expo.modules.skybolt.azureblob.provider.SasProvider
...
class BlobUploaderTest {
    ...
    fun failsFastWhenSasKeepsExpiringWithoutInfiniteLoop() = runTest {
        ...
        } catch (_: expo.modules.skybolt.core.upload.api.Err.UploadError.SasExpired) {
            // expected
        }
...
private object NoopProgressReporter : ProgressReporter {
    override fun onItemProgress(progress: expo.modules.skybolt.core.upload.api.ItemProgress) = Unit
