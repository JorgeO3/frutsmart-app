package expo.modules.skybolt.core.facade
...
import expo.modules.skybolt.core.bg.UploadWorker
...
import expo.modules.skybolt.core.net.NetworkWatcher
...
import expo.modules.skybolt.core.storage.SessionsIndex
import expo.modules.skybolt.core.storage.DataStoreSession
import expo.modules.skybolt.core.upload.api.SessionConfig
import expo.modules.skybolt.core.upload.api.SessionProgress
import expo.modules.skybolt.core.upload.api.UploadStatus
...
object SkyboltManager {
    ...
    suspend fun getSessionProgress(sessionId: String): SessionProgress? = withContext(Dispatchers.IO) {
        ...
        val completedFiles = session.itemsList.count { 
            it.status == expo.modules.skybolt.proto.ItemRecord.Status.COMPLETED
        }
