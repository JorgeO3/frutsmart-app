...
enum class ItemStatus {
    ...
    companion object {
         ...
         */
        fun fromProto(protoStatus: expo.modules.skybolt.proto.ItemRecord.Status): ItemStatus = when (protoStatus) {
            expo.modules.skybolt.proto.ItemRecord.Status.PENDING -> PENDING
            expo.modules.skybolt.proto.ItemRecord.Status.UPLOADING -> UPLOADING
            expo.modules.skybolt.proto.ItemRecord.Status.COMPLETED -> COMPLETED
            expo.modules.skybolt.proto.ItemRecord.Status.FAILED -> FAILED
            expo.modules.skybolt.proto.ItemRecord.Status.CANCELED -> CANCELED
            else -> PENDING
        }
    }
     ...
     */
    fun toProto(): expo.modules.skybolt.proto.ItemRecord.Status = when (this) {
        PENDING -> expo.modules.skybolt.proto.ItemRecord.Status.PENDING
        UPLOADING -> expo.modules.skybolt.proto.ItemRecord.Status.UPLOADING
        COMPLETED -> expo.modules.skybolt.proto.ItemRecord.Status.COMPLETED
        FAILED -> expo.modules.skybolt.proto.ItemRecord.Status.FAILED
        CANCELED -> expo.modules.skybolt.proto.ItemRecord.Status.CANCELED
    }
}
